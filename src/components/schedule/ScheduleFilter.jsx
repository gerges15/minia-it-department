      ...
      <div className="mt-4 flex flex-wrap items-center gap-2">
        ...
        {filter.entityId ? (
          <span className="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium bg-green-100 text-green-800">
            ...
            {entities.find(e => e.id === filter.entityId)?.userName || entities.find(e => e.id === filter.entityId)?.placeId || 'Selected'}
          </span>
        ) : (
          <span className="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium bg-gray-100 text-gray-800">
            {viewMode === 'staff' ? <FiUsers className="mr-1 h-3 w-3" /> : <FiMapPin className="mr-1 h-3 w-3" />}
        ...
        <button
          onClick={onReset}
          className="ml-auto inline-flex items-center gap-1 px-3 py-1 text-xs font-medium text-gray-600 bg-gray-100 rounded-md hover:bg-gray-200 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-300"
        >
