                              ...
                              {DAYS.map(day => {
                                ...
                                if (schedule) {
                                  ...
                                  return (
                                    ...
                                    >
                                      <div
                                        className="h-full w-full flex flex-col items-center justify-center bg-blue-100 border border-blue-300 rounded-lg p-2 text-xs text-blue-900 shadow-sm min-h-0"
                                        style={{ height: '100%' }}
                                      >
                                  ...
                                  return (
                                    <td
                                      key={`${day}-${hour}`}
                                      className="px-2 py-1 border-l border-gray-200 bg-gray-50"
                                      style={{ minWidth: 120 }}
                                    >
                                      {/* Empty slot */}
                                    </td>
