  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        <p className="text-gray-600">Here's an overview of your academic schedule and progress.</p>
      </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          ...
          <div className="grid grid-cols-1 gap-4">
            <button
              ...
              onClick={() => handleQuickAction('/student-timetable')}
            >
            ...
            <button
              ...
              onClick={() => handleQuickAction('/student-profile')}
            >
